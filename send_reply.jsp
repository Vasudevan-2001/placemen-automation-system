...
<%!
    ...
    String qid,select,question,ans,id; 
...
<form method=post action='update_reply.jsp'>           
<P><strong>Question:</strong><br>
    <%
        select="select * from tbl_forum ";
...
<center><textarea name='question' rows=2 cols=150 readonly wrap=virtual><%=question%></textarea></center><br>
<P><strong>Answer:</strong><br><center><textarea name='answer' rows=2 cols=150 wrap=virtual></textarea></center>
<input type='hidden' name='qid' value='<%=qid%>'>
<P><center><input type='submit' name='submit' value='send reply'></p></center>
</form>
