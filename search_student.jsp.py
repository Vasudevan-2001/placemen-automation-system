...
<!-- ========== TOP NAVBAR ========== -->
##<?php include('includes/topbar.jsp');?>
<%@include 'topbar.jsp';%>
...
print "<form class='form-horizontal' method='post' action='studentdetails.jsp'>"
print """<div class='form-group'>
<label for='default' class='col-sm-2 control-label'>Department</label>
<div class='col-sm-10'>"""
print "<select readonly name='dept'  class=textfield  style=width:200px; required>"
