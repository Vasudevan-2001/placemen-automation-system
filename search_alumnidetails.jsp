...
<%
  ...
  {  %>
        ...
        <div class='col-md-6'>
        <h2 class='title'>Manage alumni</h2>
        ...
        <li class='active'>Search alumni Details</li>
        </ul>
        </div>
        ...
        <form class='form-horizontal' method='post' action='alumnidetails.jsp'>
     ...
     <%
        ...
        <div class='col-sm-10'>
        <input type='number' min='1990' max='%s'  name='yop' class='form-control' value='<%=current_year%>'>
